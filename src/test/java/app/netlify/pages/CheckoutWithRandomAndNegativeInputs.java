...
public class CheckoutWithRandomAndNegativeInputs extends MainPage{

    public static final String LOGIN_URL = BASE_URL+"auth_ecommerce.html";

    public CheckoutWithRandomAndNegativeInputs(WebDriver driver){super (driver);}
    ...
    public boolean submitButtonIsDisplayed(){return submitOrder.isDisplayed();}
